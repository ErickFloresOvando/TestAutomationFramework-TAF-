...
*/
    ...
    */
    ...
    public void failedRegistrationWithEmptyMandatoryFields(String firstName, String lastName, String email, String telephone, String password,String confirmPassword) throws InterruptedException {
        try{
            logger.info("**** Starting [TC-003] Registro fallido por contraseñas no coincidentes ****");
            ...
            logger.info("Validating expected message...");
            String confmsg = regpage.getPasswordWarningMsg();
            if(confmsg.equals("Password confirmation does not match password!")){
                Assert.assertTrue(true);
        ...
        logger.info("**** Finished [TC-003] Registro fallido por contraseñas no coincidentes ****");    
